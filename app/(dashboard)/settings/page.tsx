  ...
  const handleSaveConfig = async () => {
      ...
      try {
          const newAiConfig = {
              provider: 'gemini',
              apiKey: geminiKey,
              model: 'gemini-1.5-flash-latest', // ATUALIZADO: Modelo Estável de Produção
                  ...
                  <div className="space-y-4 relative z-10">
                      <div>
                          ...
                          <p className="text-[10px] text-zinc-500 mt-2">
                              A chave configurada será utilizada para todos os agentes da empresa usando o modelo <strong>Gemini 1.5 Flash Latest</strong>.
