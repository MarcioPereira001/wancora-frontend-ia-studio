                ...
                <div className="flex justify-between items-baseline">
                    <h3 className={cn("text-sm font-medium truncate flex items-center gap-1", isActive ? "text-white" : "text-zinc-200")}>
                        ...
                        {contact.is_business && !contact.is_group && (
                            <span className="text-[9px] bg-zinc-700/80 text-zinc-400 px-1 py-[1px] rounded border border-zinc-600 ml-1 uppercase tracking-tighter font-semibold scale-90 origin-left">BUSINESS</span>
                        )}
                    </h3>
