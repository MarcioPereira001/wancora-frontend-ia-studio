...
import { Cloud, Key, FileText } from 'lucide-react';
...
// Ícone do Desktop (Refatorado para comportamento nativo de OS)
const DesktopIcon = ({ label, icon: Icon, onOpen, onSelect, color = "text-blue-500", active = false }: any) => (
    ...
    >
        <div className="w-12 h-12 bg-zinc-900/80 rounded-xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
...
export function DesktopEnvironment() {
  ...
  return (
    ...
    >
        ...
        {/* Windows Layer */}
        {/* Agora passamos 48px de padding bottom para não ficar atrás da Taskbar */}
        ...
        <Modal isOpen={showAuthModal} onClose={() => setShowAuthModal(false)} title="Conectar Google Drive" maxWidth="sm">
            <div className="flex flex-col items-center text-center p-4">
                ...
                <p className="text-sm text-zinc-400 mt-2 mb-6">
                    Para acessar seus arquivos, você precisa conectar sua conta Google Drive da empresa.
                </p>
