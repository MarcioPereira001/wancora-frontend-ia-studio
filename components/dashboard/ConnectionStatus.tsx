           ...
           <div className="text-center space-y-1">
              <p className="text-white font-bold text-lg flex items-center justify-center gap-2">
                  ...
                  {instance.is_business_account && (
                      <span className="text-[9px] bg-blue-500/20 text-blue-400 border border-blue-500/30 px-1.5 py-0.5 rounded flex items-center gap-1 uppercase tracking-tighter font-semibold" title="WhatsApp Business">
